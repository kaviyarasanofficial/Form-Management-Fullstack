...
if (isset($_GET['centercode']) && isset($_GET['fromDate']) && isset($_GET['toDate'])) {
    // Retrieve data from the form
    $center_code = $_GET['centercode'];
    ...
    // Modify your SQL query to select data within the specified date range and for the given data center
    $sql = "SELECT * FROM formcliant WHERE Center_Code = '$center_code' AND dt BETWEEN '$start_date' AND '$end_date'";
