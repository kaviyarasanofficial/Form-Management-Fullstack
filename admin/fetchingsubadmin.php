                                ...
                                if (mysqli_num_rows($result) > 0) {
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        echo '<td>' . $row['status'] . '</td>';
                                         ...
                                         echo '<td>';
                                        echo '<a href="activateuser.php?id=' . $row['sno'] . '" class="btn btn-success">Activate</a> ';
                                        echo '<a href="deactivateuser.php?id=' . $row['sno'] . '" class="btn btn-danger mt-2">Deactivate</a>';
