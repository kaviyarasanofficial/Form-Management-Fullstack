...
$queryFormcliant = "SELECT * FROM formcliant WHERE Center_Code = '$adminDataCenterCode' ORDER BY sno DESC;";
...
<!--<script type="text/javascript" src="tableExport/jquery.base64.js"></script>-->
            ...
            <ul class="navbar-nav">
              <li>
                <a class="nav-link px-3 sidebar-link" data-bs-toggle="collapse" href="#projects">
                  ...
                  <span onclick="window.location.href='betaadminindex.php';" >Lead Management</span>
                  <span class="ms-auto">
  ...
  <div class="row">
    ...
    <div class="col">
     <form action="exportbetaexcel.php" method="get">
            <div class="row">
                
                <input type="hidden" class="form-control" value="<?php echo $adminDataCenterCode; ?>" name="centercode" required>
        ...
        <button type="submit" class="btn btn-primary" name="open_modal">Export Pdf</button>
        
        <!--<a href="export.php"><button type="button" class="btn btn-primary">Export Excell</button></a>-->
...
<!--		</div>	-->
                        ...
                        <!--<a href="genratepdf.php" target="_blank">Generate PDF</a>-->
